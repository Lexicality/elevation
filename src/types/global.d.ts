declare module "unobservable" {
    ...
    export function observable<Obj, Events extends EventManifest<Events> = {}>(
        el: Obj,
        options?: {
    ...
    export function asObservable<
        Obj,
        Events extends EventManifest<Events> = {},
    >(
        el: Obj,
        options?: {
            numPreallocatedHandlers?: number;
    ...
    export class Observable<Events extends EventManifest<Events>>
